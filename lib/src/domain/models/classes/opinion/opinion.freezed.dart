...
mixin _$Opinion {
  ...
  @JsonKey(name: 'id')
  String? get serverUUID => throw _privateConstructorUsedError;
...
abstract class $OpinionCopyWith<$Res> {
  ...
  $Res call(
      ...
      @PrimaryKey(autoGenerate: true)
      int? id,
      @JsonKey(name: 'id') String? serverUUID,
      String title,
      String description,
      String url,
      String? urlToImage,
    ...
    return _then(_value.copyWith(
      id: freezed == id
          ...
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
      serverUUID: freezed == serverUUID
          ? _value.serverUUID
          : serverUUID // ignore: cast_nullable_to_non_nullable
              as String?,
      title: null == title
          ? _value.title
...
class _$_Opinion extends _Opinion {
  _$_Opinion(
      ...
      @PrimaryKey(autoGenerate: true)
      this.id,
      @JsonKey(name: 'id') required this.serverUUID,
      required this.title,
...
abstract class _Opinion extends Opinion {
  factory _Opinion(
      ...
      @PrimaryKey(autoGenerate: true)
      final int? id,
      @JsonKey(name: 'id') required final String? serverUUID,
